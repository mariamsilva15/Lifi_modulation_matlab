function pat = diffdecoder(pat,modformat)

%DIFFDECODER Differential decoder
%   PAT=DIFFDECODER(PAT,MODFORMAT) given the pattern PAT (either in
%   binary or decimal representation) returns the  pattern differentially 
%   decoded.
%
%   MODFORMAT is the modulation format (see MODFORMATINFO).
%
%   See also PATTERN, DIFFENCODER.
%
...
switch p.family
    ...
    case 'psk' % differential coding.
        ...
        stars = conj(stars).*fastshift(stars,1);
